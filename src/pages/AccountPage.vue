...
import { getTableColumns, getMockTableData } from '@/components/AccountPage/AccountPageTable';
...
const handleSave = () => {
    if (drawerStore.mode === 'edit') {
        // 調用編輯角色的 API
        console.log('打管理帳號編輯角色api:', drawerStore.editData);
    } else {
        // 調用新增角色的 API
        console.log('打管理帳號新增角色api:', drawerStore.editData);
    }
